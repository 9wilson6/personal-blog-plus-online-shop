...
Route::prefix('admin')->group(function (){
    ...
    Route::post('users/{id}/delete', 'AdminController@deleteUsers')->name('adminDeleteUser');
    Route::get('users/{id}/edit', 'AdminController@editUser')->name('userEdit');
    Route::post('users/{id}/update', 'AdminController@updateUser')->name('userAccountEdit');
    ...
    Route::post('products/new', 'AdminController@postNewProduct')->name('postNewProduct');

    Route::get('product/{id}', 'AdminController@editProduct')->name('adminEditProduct');
    Route::post('product/{id}', 'AdminController@updateEditedProduct')->name('updateProduct');
