            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    @foreach($comments as $comment)
                        <tr>
                            <td>{{$comment->id}}</td>
                            <td class="text-nowrap"><a href="{{route('singlePost', $comment->id )}}">{{$comment->title}}</a></td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form  id="postId-{{$comment->id}}" action="{{route('adminDeleteComment', $comment->id)}}" method="POST">@csrf
